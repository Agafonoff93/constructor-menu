...
// 	// const formImageRemove = document.
...
// 				let addIcon = document.querySelector(".file__item");

// 				console.log(document.querySelectorAll(".file__item-preview").length)
				
// 				if(formImage.hasAttribute('multiple')){
// 					if(document.querySelectorAll(".file__item-preview").length >= 10){
...
// 					<div class="file__item-preview-remove"></div>
...
// let slider_menu = new Swiper(this,'.box-slider__slider', {
// 	/*
// 	effect: 'fade',
// 	autoplay: {
// 		delay: 3000,
		...
		select_option.addEventListener('click', function () {
			...
			if (select_type == 'input') {
				...
				if (original.hasAttribute('multiple')) {
					...
					select.querySelector('.select__value').innerHTML = '<span>' + img_tag + select_option_text + '</span>';
					original.value = select_option_value;
					select_option.style.display = 'none';
				}
			}
...
function select_get_options(select_options) {
	if (select_options) {
		...
		for (let index = 0; index < select_options.length; index++) {
			...
			const select_object = document.querySelector('.select__img-sel')
			const select_cr_atr = document.createElement('img');
			select_cr_atr.setAttribute('data-key', index);
			select_cr_atr.src = `img/icons/`+ index +`.png`;
			const img_tag = select_object.appendChild(select_cr_atr);
			console.log(select_object.appendChild(select_cr_atr));
			
			if (select_option_value != '') {
				
				const select_option_text = select_option.innerHTML;
				select_options_content = select_options_content + '<div data-value="' + select_option_value + '" class="select__option">'+ select_cr_atr   + select_option_text + '</div>';
			}
		}
