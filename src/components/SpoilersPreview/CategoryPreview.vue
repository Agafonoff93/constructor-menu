	...
	<div  class="main-preview-categories__wrapper">
		<div  class="main-preview-categories__block">
					...
					:class="{_focus: uiVisible}">
						...
						<div class="main-preview-categories__title _title" :class="{'_active': uiVisible, '_toggle': toggleShow }">{{ category.label }}</div>
...
// import MyPenelUi from  '@/components/UI/MyPenelUi.vue'
