	...
	<div  class="main-preview-categories__wrapper">
		<div  class="main-preview-categories__block">
					...
					:class="{_focus: uiVisible, _drag_item: draggableCategory}">
						<div class="main-preview-categories__label _label">
						...
						<div class="main-preview-categories__title _title" :class="{'_active': uiVisible, '_toggle': toggleShow && !draggableCategory }">{{ category.label }}</div>
						<transition name="ui">
						<div v-show="!draggableRubric && !draggableCategory && !draggableDish" class="main-preview-categories__text _text">{{ category.text }}</div>
				    	</transition>
					</div>
