	...
	<div  class="main-preview-categories__wrapper">
		<div  class="main-preview-categories__block">
					...
					:class="{_focus: uiVisible, _drag_item: draggableCategory}">
						...
						<div class="main-preview-categories__title _title" :class="{'_arrow-visible': category.rubrics.length > 0 ,'_active': uiVisible, '_toggle': toggleShow && !draggableCategory }">{{ category.label[locale] }}</div>
						<transition name="ui">
