	...
	<div class="result__block">
		...
		<div class="result__item href-result">
			...
			<div class="href-result__link">
				<span ref="copyTarget">{{ user.templateUrl ? `${user.templateUrl}` : 'Что-то пошло не так, вернитесь назад' }}</span>
			</div>
		</div>	
	...
	<div class="result__block">
		<div class="result__item href-result">
			...
			<div class="href-result__qr-code _ibg">
				<img ref="linkImage" :src="(`https://api.qrserver.com/v1/create-qr-code/?data=${user.templateUrl}&size=250x250`)" alt="qr-code">
...
export default {
    ...
    async copyToClipboard() {
	 ...
	 ...mapActions({	
		checkWebsite: 'user/checkWebsite',
			fetchUser: 'user/fetchUser',
			getQrCode: 'user/getQrCode',
	}),
	windowsHref(){
		window.location.href = 'https://api.qrserver.com/v1/create-qr-code/?data=${user.templateUrl}&size=250x250'
	}
  },
	computed: {
	...mapState({
  ...
  mounted(){
	this.fetchUser()
	this.getQrCode(this.user.templateUrl)
	console.log(this.user)
	console.log(this.user.templateUrl)
  }
}
</script>
