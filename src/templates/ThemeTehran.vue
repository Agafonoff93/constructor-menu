...
<style scoped>
@charset "UTF-8";
@import url(https://fonts.googleapis.com/css?family=Open+Sans:700&display=swap&subset=cyrillic-ext);
@import url(https://fonts.googleapis.com/css?family=Roboto:regular,600&display=swap&subset=cyrillic-ext);
@font-face {
	font-family: "KyivRegion";
	font-display: swap;
	src: url("@/assets/fonts/KyivRegion-Regular.woff2") format("woff2"), url("@/assets/fonts/KyivRegion-Regular.woff") format("woff");
	font-weight: 500;
	font-style: normal;
 }
* {
...
._icon-arrow-down::after {
   min-width:12px;
	...
	width: 12px;
	height: 8px;
	background: url(@/assets/icons/arrow-down-s-yellow.svg) no-repeat;
}
