<template>
	<div :style="{ 'background': `  url(${require('@/assets/bg-templates/bg-template-14.jpeg')}) repeat 10%` }" class="wrapper">
		<header class="header"> 
			<div class="header__container _container">
				<div class="header__top">
					...
					<MenuItems :style="{ 'background': `url(${require('@/assets/bg-templates/bg-template-14.jpeg')}) repeat 10%` }" class="menu__container">
...
@font-face {
	...
	font-display: swap;
	src: url("@/assets/fonts/timesnewromanpsmt.woff2") format("woff2"), url("@/assets/fonts/timesnewromanpsmt.woff") format("woff");
	font-weight: 400;
	font-style: normal;
 }
...
.wrapper {
	...
	background: url(@/assets/bg-templates/bg-template-14.jpeg) repeat 10%;
	font-family: "Times New Roman";
	color: #828282;
}
