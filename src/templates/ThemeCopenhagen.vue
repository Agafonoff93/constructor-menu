...
<style scoped>
@charset "UTF-8";
@import url(https://fonts.googleapis.com/css?family=Montserrat:700&display=swap&subset=cyrillic-ext);
@import url(https://fonts.googleapis.com/css?family=Roboto:regular,700&display=swap&subset=cyrillic-ext);

@font-face {
	font-family: "Laptev";
	font-display: swap;
	src: url("@/assets/fonts/Laptev_Brush.woff2") format("woff2"), url("@/assets/fonts/Laptev_Brush.woff") format("woff");
	font-weight: 400;
	font-style: normal;
 }
...
.wrapper {
	...
	background: linear-gradient(0deg, rgba(19, 2, 2, 0.75), rgba(19, 2, 2, 0.75)), url(@/assets/bg-templates/bg-template-5.jpg) repeat 10%;
	font-family: "Roboto";
	color: #BDBDBD;
}
