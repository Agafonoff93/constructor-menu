...
@import url(https://fonts.googleapis.com/css?family=Montserrat:regular,600&display=swap&subset=cyrillic-ext);
...
.wrapper {
	...
	background: linear-gradient(180deg, #25464B 0%, #051A1C 100%);
	font-family: "Montserrat";
	color:#ffffff;
}
...
.header__title {
	...
	text-align: center;
	font-family: Bitter;
	background: linear-gradient(91.41deg, #B56122 -0.44%, #D98D41 34.61%, #B56122 64.43%, #D98D41 100%);
