...
@import url(https://fonts.googleapis.com/css?family=Rubik:regular&display=swap&subset=cyrillic-ext);
@font-face {
	font-family: "RubikOne";
	font-display: swap;
	src: url("@/assets/fonts/RubikOne-Regular.woff2") format("woff2"), url("@/assets/fonts/RubikOne-Regular.woff") format("woff");
	font-weight: 400;
	font-style: normal;
 }
