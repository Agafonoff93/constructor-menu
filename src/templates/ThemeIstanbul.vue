...
@font-face {
	...
	font-display: swap;
	src: url("@/assets/fonts/Boncegro FF 4F.woff2") format("woff2"), url("@/assets/fonts/Boncegro FF 4F.woff") format("woff");
	font-weight: 500;
	font-style: normal;
 }
...
._icon-arrow-down::after {
   min-width:12px;	
	...
	width: 12px;
	height: 8px;
	background: url(@/assets/icons/arrow-down-s-brown.svg) no-repeat;
}
