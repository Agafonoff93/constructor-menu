...
.wrapper {
	...
	background: linear-gradient(0deg, rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url(@/assets/bg-templates/bg-template-16.jpeg) 50% ;
	color: #408082;
	font-family: "Roboto";
}
...
.menu__container {
	...
	top: 0;
	left: 0;
	background: linear-gradient(0deg, rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url(@/assets/bg-templates/bg-template-16.jpeg);
