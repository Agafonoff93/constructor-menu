		...
		<header class="header">
			<div class="header__container _container">
				<div class="header__top">
					...
					<MenuItems :style="{ 'background': `linear-gradient(0deg, rgba(11, 16, 21, 0.9), rgba(11, 16, 21, 0.9)), url(${require('@/assets/bg-templates/bg-template-2.jpg')}) repeat 10%` }" class="menu__container _container">
...
<script setup>
  import { Menu, MenuButton, MenuItems, MenuItem, 
	Disclosure, DisclosureButton, DisclosurePanel,Listbox, ListboxButton, ListboxOptions, ListboxOption  } from '@headlessui/vue'
</script>
